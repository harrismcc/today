/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 02bbbec6745c35a1656c139fdff51e51)
// Runtime types generated with workerd@1.20260911.1 2026-09-14 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	AUTH_EMAIL_FROM: "Today <onboarding@resend.dev>";
	BETTER_AUTH_ALLOWED_HOSTS: "today.harrismcc.workers.dev,today.harrismccullers.com";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_EMAIL_FROM" | "BETTER_AUTH_ALLOWED_HOSTS" | "BETTER_AUTH_SECRET" | "RESEND_API_KEY">> {}
}
